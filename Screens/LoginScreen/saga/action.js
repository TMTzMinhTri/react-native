...
const saveData = (action) => {
    return AsyncStorage.setItem('userInfo', JSON.stringify({ email: "tmtzminhtri@gmail.com", password: "123123123" }))
}

const postLogin = (email, password) => {
    return Api.post('/login', JSON.stringify({ email: "hai@gmail.com", password: "123456" }))
}
